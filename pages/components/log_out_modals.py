...
img_path_logout = os.path.join(BASE_DIR, "images", "log_out.png")
img_path_success = os.path.join(BASE_DIR, "images", "log_out_success.png")


class LogoutConfirmModal(QWidget):
    confirm_logout = Signal()
    ...
    def __init__(self, parent):
        ...
        icon_lbl = QLabel()
        pixmap = QPixmap(img_path_logout)
        ...
        title_lbl = QLabel("Are you sure want to log out?")
        title_lbl.setFont(QFont(APP_FONT, 15, QFont.Bold))
        ...
        logout_btn = PrimaryButton("Log Out")
...
class LogoutSuccessModal(QWidget):
    success_ok = Signal()
    ...
    def __init__(self, parent):
        ...
        title_lbl = QLabel("You successfuly loged out")
